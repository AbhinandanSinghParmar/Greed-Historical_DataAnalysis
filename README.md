...
Approach
Cleaned and preprocessed both datasets, handling missing and inconsistent values.
Aligned trade timestamps with daily sentiment data.
Engineered key performance metrics such as net PnL, profitability indicators, and risk-adjusted returns.
Conducted exploratory analysis to compare trader behavior across different sentiment phases.
Applied statistical tests to evaluate differences in performance between Fear and Greed market conditions.

Key Findings
Trades during Fear and Extreme Fear phases tend to exhibit better risk-adjusted performance.
Greed and Extreme Greed phases are associated with increased trade size, aggressive execution, and higher losses.
Market sentiment significantly influences trader behavior, execution style, and overall performance.
